...
import ExaminationDetailsView from '../views/ExaminationDetailsView.vue'; // Import the new component
...
const routes = [
    ...
    { path: '/examinations/:id', component: ExaminationDetailsView, name: 'ExaminationDetails' }, // New route
